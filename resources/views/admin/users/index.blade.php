    ...
    <div class="flex min-h-screen bg-[#fdfaf8]">
        ...
        <main class="flex-1 p-8">
            <div class="flex items-center justify-between mb-6">
                <h1 class="text-3xl font-bold text-[#5C4033]">Users</h1>
                <a href="{{ route('admin.users.create') }}" class="bg-[#b97456] text-white px-4 py-2 rounded hover:bg-[#a56347]">Add User</a>
            </div>
